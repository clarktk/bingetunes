                                                    ...
                                                    <form action="#" method="post" id="contact_form" class="contact-form">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                <label for="author">First Name</label><input type="text" id="firstname" class="comments-line" name="author">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                <label for="author">Last Name</label><input type="text" id="lastname" class="comments-line" name="author">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
