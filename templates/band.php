<div class="content-main main-videos">
                                <section class="content-section videos-section extend">
                                    <div class="wrap content-videos extend">
                                        ...
                                        <header>
                                            <h2 class="entry-header opacity">Band Name</h2>
                                        </header>
...
<!--                                            <div class="tabs-wrap videos-tabs opacity" id="videos_tabs">
                                        ...
                                        <!-- Tab panes -->
                                            <div class="tab-content bootstrap-tab-content opacity">
                                                <div class="tab-pane fade in active" id="category1">
                                                            <div class="the-slider" data-tesla-container=".slide-wrapper" data-tesla-prev=".slide-left" data-tesla-next=".slide-right" data-tesla-item=".slide" data-tesla-plugin="slider">
                                                            <div class="slider-wrap">
                                                                ...
                                                                <div class="the-slider-bullets">
                                                                        ...
                                                                        <ul class="the-bullets" data-tesla-plugin="bullets">
                                                                            <li><img src="images/thumbs/thumb1.jpg" alt="thumb" /></li>
